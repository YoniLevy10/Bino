...
**Bino** (Building Intelligence & Operations) — מערכת SaaS רב-דיירית לזיכרון תפעולי חכם לכל בניין (לא «עוד מערכת תקלות»).

הבידול: למידה מהיסטוריית תקלות/ציוד/ספקים/עלויות; המלצה אוטומטית לעובד או ספק; זיהוי תקלות חוזרות; התראות SLA מוקדמות; חיזוי כשלים; והוכחת חיסכון בזמן וכסף לחברת הניהול. מדדי ליבה: זמן עד שיוך, זמן עד פתרון, שיעור תקלות חוזרות, עלות תחזוקה לבניין, אחוז טיפול ללא התערבות מנהל. עקרונות מחייבים: `.cursor/rules/bino-product-differentiation.mdc` ו־`CLAUDE.md`.
